...
const SummaryCards: React.FC = () => {
    // Mock data
    const totalFlights = 5820000;
    const onTimeFlights = 3640000;
    const delayedFlights = 2090000;
    const cancelledFlights = 90000;

    const pct = (count: number) => ((count / totalFlights) * 100).toFixed(2);

    const totalDelay = 2500000;
                ...
                <Col xs={24} sm={12} md={6}>
                    <Card variant="outlined" styles={{ body: cardBody }}>
                        <div style={{ display: "flex", justifyContent: "space-between", width: "100%" }}>
                            ...
                            />
                            <Text strong style={{ fontSize: 18, color: "#3f8600", alignSelf: "center" }}>
                                {pct(onTimeFlights)}%
                            </Text>
                        </div>
                    </Card>
                ...
                <Col xs={24} sm={12} md={6}>
                    <Card variant="outlined" styles={{ body: cardBody }}>
                        <div style={{ display: "flex", justifyContent: "space-between", width: "100%" }}>
                            ...
                            />
                            <Text strong style={{ fontSize: 18, color: "#fa8c16", alignSelf: "center" }}>
                                {pct(delayedFlights)}%
                            </Text>
                        </div>
                    </Card>
                ...
                <Col xs={24} sm={12} md={6}>
                    <Card variant="outlined" styles={{ body: cardBody }}>
                        <div style={{ display: "flex", justifyContent: "space-between", width: "100%" }}>
                            ...
                            />
                            <Text strong style={{ fontSize: 18, color: "#cf1322", alignSelf: "center" }}>
